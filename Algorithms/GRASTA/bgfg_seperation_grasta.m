...
function [fgs_cmp,bgs_cmp,vInfo,video_matrix] = bgfg_seperation_grasta(U_hat, videopath, subsampling , status, OPTIONS, OPTS,...
...
for i=1:Video_Length,
    ...
    if frame_count==1,
        ...
        video_matrix    = zeros(DIM, length(frame_names));
